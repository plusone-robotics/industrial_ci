...
* **ROSINSTALL_AUTOMERGE** (default: not set): When set to true, any `wstool merge` operations will have the `-y` option set, preventing any CLI prompts from appearing when any element details are changed.
